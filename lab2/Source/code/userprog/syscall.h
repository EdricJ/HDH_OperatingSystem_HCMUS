...
/*
 * Read the integer from user type it on console
 */ 
int ReadNum();

/*
 * Print the integer and return the result to console
 */ 
void PrintNum(int num);

/*
 * Read the character from user type it on console
 */ 
char ReadChar();

/*
 * Print the character and return the result to console
 */ 
void PrintChar(char character);

/*
 * Print the random number and return the result to console
 */ 
int RandomNum();

/*
 * Read the character string from user type it on console
 */ 
void ReadString(char buffer[], int length);

/*
 * Print the character string and return the result to console
 */ 
...
#define Console_Input	0  //distinguish from other variables in console.h
